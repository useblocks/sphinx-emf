...
def test_basic_roundtrip(tmp_path, caplog):
    ...
    # get current python interpreter and run sphinx-build from it
    ...
    path_out = str(tmp_path / "_build" / "emf" / "m0_model_out.xmi")
...
def gen_builder_conf():
    ...
    return textwrap.dedent(
        ...
        emf_xmi_output_name = "m0_model_out.xmi"
...
def gen_common_conf(ecore_path):
    ...
    return textwrap.dedent(
        f"""\
        emf_path_m1_model = r"{ecore_path}"
